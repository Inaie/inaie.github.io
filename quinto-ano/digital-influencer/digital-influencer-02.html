...
<header>
	...
	<div class="container">
	    ...
	    <div class="row">	
	    	<div class="col-sm" >
    			<div class="text-center">
			    	<p><h5>A digital influencer is someone who can influence other people.</p></h5>
		    	</div>
	    	</div>
	    </div>
		...
		<div class="row">
			<div class="col-6 text-center">
				<a class="btn btn-primary" href="../digital-influencer/digital-influencer-01.php" role="button">Prev</a>	
		    </div>

	      	<div class="col-6 text-center">
	      		<a class="btn btn-primary" href="../digital-influencer/digital-influencer-03.php" role="button">Next</a>
	      	</div>	
		</div>
	</div>		
