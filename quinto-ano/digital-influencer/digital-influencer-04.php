...
<header>
	...
	<div class="container">
	    ...
	    <div class="row">	
	    	<div class="col-sm" >
    			<div class="text-center">
					<p><h5>She works on the YouTube channel, blog posts, e-books, Facebook and Instagram posts.</h5></p>
		    	</div>
	    	</div>
	    </div>
		...
		<div class="row">
			<div class="col-6 text-center">
				<a class="btn btn-primary" href="../digital-influencer/digital-influencer-03.php" role="button">Prev</a>	
		    </div>
